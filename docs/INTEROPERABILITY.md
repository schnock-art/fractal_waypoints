...
8. **Phase 11.5/11.6:** version performance setup separately from profiles, session runtime, Waypoints, takes, and graph layout; then define recording/replay/export. Deterministic Journey export must use recorded or otherwise reproducible inputs, not live hardware sampled opportunistically.
